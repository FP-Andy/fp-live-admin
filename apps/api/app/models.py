...
class FcmSubmission(Base):
    ...
    card_type: Mapped[str] = mapped_column(String, nullable=False, default="PLAYER")
    penalty_shootout: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
