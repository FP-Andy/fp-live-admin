...
def process_job(
    ...
    *,
    ...
    if workdir is not None:
        ...
        return _process_in(workdir, manifest, clip_specs, storage, pipeline_version, overlay)
    with tempfile.TemporaryDirectory(prefix="fpc_job_") as tmp:
        return _process_in(Path(tmp), manifest, clip_specs, storage, pipeline_version, overlay)
