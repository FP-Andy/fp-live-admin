...
# 1920x1080 기준으로 로고 왼쪽 위가 (1740, 80) 에 오는 자리.
# 이 값들은 '여백을 뺀 놓을 수 있는 범위' 안에서의 비율(0~100)이라 다른 규격에서도
# 같은 비율로 따라간다 — 픽셀로 박으면 4K·파노라마에서 자리가 어긋난다.
#   여백 40 · 범위 1744x899 → 40 + 1744*0.974771 = 1740 / 40 + 899*0.044494 = 80
DEFAULT_POS_X = 97.4771   # 0=왼쪽, 100=오른쪽
DEFAULT_POS_Y = 4.4494    # 0=위,   100=아래
